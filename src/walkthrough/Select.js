...
export default class Select extends React.Component<
	VisibleState,
	PetNameTextInputIsVisibleState,
	SpeciesSelected
> {
	state = {
		visible: false,
	...
	render(): React.Node {
		const selectPetBreedMessage = (
			<Text style={styles.message}>
				Please select the breed of your first pet.{" "}
			</Text>
		);

		var selectedPet = (
			<FontAwesome5
				name={this.state.speciesSelected}
				size={Theme.typography.header1.fontSize}
		...
		return (
			<ScrollView contentContainerStyle={styles.scrollContainer}>
				...
				<View style={styles.container}>
					<Button label="Dog" onPress={this.selectDog} full style="primary" />
					<Button label="Cat" onPress={this.selectCat} full style="primary" />
					<Button label="Bird" onPress={this.selectBird} full style="primary" />
				</View>
				<View style={styles.container}>
					<Button
						label="Horse"
						...
						style="primary"
					/>
					<Button label="Fish" onPress={this.selectFish} full style="primary" />
					<Button
						label="Exotic"
				...
				<View>
					{this.state.petNameTextInputIsVisible ? (
						<TextInputComponent />
					) : (
						selectPetBreedMessage
					)}
				</View>
