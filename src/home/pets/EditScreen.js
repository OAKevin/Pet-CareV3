...
export default class EditScreen extends React.Component {
	constructor(props) {
		...
		this.avatar =
			"https://i.pinimg.com/originals/bc/78/4f/bc784f866bb59587b2c7364d47735a25.jpg";
				...
				if (doc.data().pic == "null") {
					switch (this.state.petDetails.species) {
						...
						case "Horse":
							this.setState({
								avatar:
									"https://images.pexels.com/photos/2123375/pexels-photo-2123375.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
								avatarBackground:
									"https://images.pexels.com/photos/2123375/pexels-photo-2123375.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
							});
							break;
						case "Fish":
							this.setState({
								avatar:
									"https://images.immediate.co.uk/production/volatile/sites/4/2009/07/GettyImages-931270318-43ab672.jpg?quality=90&resize=940%2C400",
								avatarBackground:
									"https://images.immediate.co.uk/production/volatile/sites/4/2009/07/GettyImages-931270318-43ab672.jpg?quality=90&resize=940%2C400",
							});
							break;
						case "Exotic":
							this.setState({
								avatar:
									"https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Male_Green_Iguana_Belize.jpg/220px-Male_Green_Iguana_Belize.jpg",
								avatarBackground:
									"https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Male_Green_Iguana_Belize.jpg/220px-Male_Green_Iguana_Belize.jpg",
							});
							break;
	...
	updateSpecies(species) {
		...
		switch (species) {
			case "isDog":
				this.setState({
					petBiology: { species: "Dog", breed: this.state.petBiology.breed },
				});
				break;
			case "isCat":
				this.setState({
					petBiology: { species: "Cat", breed: this.state.petBiology.breed },
				});
				break;
			case "isBird":
				this.setState({
					petBiology: { species: "Bird", breed: this.state.petBiology.breed },
				});
				break;
			case "isFish":
				this.setState({
					petBiology: { species: "Fish", breed: this.state.petBiology.breed },
				});
				break;
			case "isHorse":
				this.setState({
					petBiology: { species: "Horse", breed: this.state.petBiology.breed },
				});
				break;
			case "isExotic":
				this.setState({
					petBiology: { species: "Exotic", breed: this.state.petBiology.breed },
				});
				break;
		}
	}
	...
	handleBreed = text => {
		this.setState({
			petBiology: { species: this.state.petBiology.species, breed: text },
		});
	};
				...
				>
					<View style={styles.container}>
						...
						<Card containerStyle={styles.cardContainer}>
							<Text type="header3" style={styles.cardText}>
								{" "}
								Edit Information{" "}
							</Text>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isBird && (
									<TouchableOpacity
										onPress={() => this.updateSpecies("isBird")}
									>
								...
								{this.state.isHorse && (
									<TouchableOpacity
										onPress={() => this.updateSpecies("isHorse")}
									>
								...
								{this.state.isFish && (
									<TouchableOpacity
										onPress={() => this.updateSpecies("isFish")}
									>
								...
								{this.state.isExotic && (
									<TouchableOpacity
										onPress={() => this.updateSpecies("isExotic")}
									>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isInactive && (
									<TouchableOpacity
										onPress={() => this.updateActivity("isInactive")}
									>
								...
								{this.state.isMild && (
									<TouchableOpacity
										onPress={() => this.updateActivity("isMild")}
									>
								...
								{this.state.isModerate && (
									<TouchableOpacity
										onPress={() => this.updateActivity("isModerate")}
									>
								...
								{this.state.isHigh && (
									<TouchableOpacity
										onPress={() => this.updateActivity("isHigh")}
									>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isIndoors && (
									<TouchableOpacity
										onPress={() => this.updateClassification("isIndoors")}
									>
								...
								{this.state.isOutdoors && (
									<TouchableOpacity
										onPress={() => this.updateClassification("isOutdoors")}
									>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isSpayedOrNeutered && (
									<TouchableOpacity
										onPress={() =>
											this.updateSpayNeuter_Status("isSpayedOrNeutered")
										}
									>
								...
								{this.state.isIntact && (
									<TouchableOpacity
										onPress={() => this.updateSpayNeuter_Status("isIntact")}
									>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isNotPregnant && (
									<TouchableOpacity
										onPress={() => this.updatePregnancy("isNotPregnant")}
									>
										<FontAwesome5 name="ban" size={30} color="#c93335" />
									</TouchableOpacity>
								)}
								...
								{this.state.isFirstStage && (
									<TouchableOpacity
										onPress={() => this.updatePregnancy("isFirstStage")}
									>
								...
								{this.state.isSecondStage && (
									<TouchableOpacity
										onPress={() => this.updatePregnancy("isSecondStage")}
									>
								...
								{this.state.isThirdStage && (
									<TouchableOpacity
										onPress={() => this.updatePregnancy("isThirdStage")}
									>
							...
							<View style={styles.inputContainer}>
								...
								{this.state.isNonLactating && (
									<TouchableOpacity
										onPress={() => this.updateLactating("isNonLactating")}
									>
										<FontAwesome5 name="ban" size={30} color="#c93335" />
									</TouchableOpacity>
								)}
								...
								{this.state.isShortTime && (
									<TouchableOpacity
										onPress={() => this.updateLactating("isShortTime")}
									>
										<FontAwesome5
											name="wine-bottle"
											size={22}
								...
								{this.state.isMediumTime && (
									<TouchableOpacity
										onPress={() => this.updateLactating("isMediumTime")}
									>
										<FontAwesome5
											name="wine-bottle"
											size={26}
								...
								{this.state.isLongTime && (
									<TouchableOpacity
										onPress={() => this.updateLactating("isLongTime")}
									>
										<FontAwesome5
											name="wine-bottle"
											size={30}
