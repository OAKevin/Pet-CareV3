		...
		return (
			<ScrollView style={styles.scroll} persistentScrollbar={false}>
				<NavHeaderWithButton
					title="Add Pet"
					buttonIcon="check"
					buttonFn={this.addPetToFireStore}
					back
				...
				<Container style={styles.container}>
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ speciesOpen: open });
						}}
					...
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ activityOpen: open });
						}}
					...
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ classificationOpen: open });
						}}
					...
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ spayNeuter_StatusOpen: open });
						}}
					...
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ pregnancyOpen: open });
						}}
					...
					<DropDownPicker
						...
						setOpen={open => {
							this.setAllClose();
							this.setState({ lactatingOpen: open });
						}}
